                ...
                <React.Fragment>
                  <Paper elevation={3}>
                    ...
                    <TextField
                      ...
                      label="Apellidos"
                      variant="outlined"
                      defaultValue={clientProfile.apellidos}
                    >
                      {" "}
                    </TextField>
                    <TextField
                    ...
                    <Table>
                      <TableBody>
                        <TableRow style={{ maxHeight: "30px !important" }}>
                          <TableCell>
                            ¿Alguna vez le ha diagnosticado su médico un
                            problema en el corazón, recomendándole que solo haga
                            deporte bajo supervisión médica?
                          </TableCell>
                          <TableCell>
                            <Button
                        ...
                        <TableRow>
                          <TableCell>
                            ¿Se marea frecuentemente o ha perdido el
                            conocimiento demasiadas veces?
                          </TableCell>
                          <TableCell>
                            <Button
                        ...
                        <TableRow>
                          <TableCell>
                            ¿Toma medicación para la presión arterial u otro
                        ...
                        <TableRow>
                          <TableCell>
                            ¿Tiene problemas en las articulaciones o algún dolor
                            que se agrava haciendo ejercicio?
                          </TableCell>
                          <TableCell>
                            <Button
